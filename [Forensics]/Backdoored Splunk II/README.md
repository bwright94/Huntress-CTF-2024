...
Attachments: 
Splunk_TA_windows.zip  

Examine extracted files for unusual contents

/Splunk_TA_windows/bin/powershell/dns-health.ps1 (9 KB)
```
...
Send request to the challenge server to retrieve the flag:

```
curl -X GET http://challenge.ctf.games:<PORT> \
-H "Authorization: Basic YmFja2Rvb3I6dGhpc19pc190aGVfaHR0cF9zZXJ2ZXJfc2VjcmV0"
```
